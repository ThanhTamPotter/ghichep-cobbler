...
cat <<HERE > /var/lib/cobbler/kickstarts/OPS_Block$blk_num.cfg
...
cobbler profile add --name=OPS-Block$blk_num --distro=US160403-x86_64 --kickstart=/var/lib/cobbler/kickstarts/OPS_Block$blk_num.cfg
