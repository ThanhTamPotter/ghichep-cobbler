...
cat <<HERE > /var/lib/cobbler/kickstarts/OPS_COM$com_num.cfg
...
cobbler profile add --name=OPS-Compute$com_num --distro=US160403-x86_64 --kickstart=/var/lib/cobbler/kickstarts/OPS_COM$com_num.cfg
